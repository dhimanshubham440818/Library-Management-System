...
public class IssueBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (t1.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Plase enter student ID");
        } else if (t2.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Student ID Not Registered");
            ...
            try {
                ...
                if (t6.getText().equals("YES")) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "A student can take only one book at a time");
                    }
                } else if (t6.getText().equals("NO")) {
