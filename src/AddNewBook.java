...
public class AddNewBook extends javax.swing.JFrame {
    ...
    private void c3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c3ActionPerformed
        if (c3.getSelectedItem() == "Select Class") {
            c4.removeAllItems();
        } else if (c3.getSelectedItem() == "Science") {
            c4.removeAllItems();
            c4.addItem("Select Class");
            c4.addItem("MCA I YEAR");
            c4.addItem("MCA II YEAR");
        } else if (c3.getSelectedItem() == "Arts") {
            c4.removeAllItems();
            c4.addItem("Select Class");
            c4.addItem("BA I YEAR");
            c4.addItem("BA II YEAR");
            c4.addItem("BA III YEAR");
        } else if (c3.getSelectedItem() == "Commerce") {
            c4.removeAllItems();
            c4.addItem("Select Class");
            c4.addItem("BCom I YEAR");
            c4.addItem("BCom II YEAR");
            c4.addItem("BCom III YEAR");
        }
